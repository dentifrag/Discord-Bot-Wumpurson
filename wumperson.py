...
# commands we didn't want to implement on our server, but they're here
# @bot.command()
...
async def friends(ctx):
    try:
        ...
        player.play(discord.FFmpegPCMAudio(executable=r"path to ffmpeg", source="friends.mp3"), after=lambda: print('done'))
...
async def on_member_join(member):
    ...
    channel = bot.get_channel('channel ID for main server to send to')
